...
export default function Home() {
  ...
  const involvements = [
    ...
    },
    {
      ...
      place: 'FGCU',
      date: 'Fall 2023 – Present',
      description: 'Tutored over 400 hours for freshmen in Programming I/II and promoted engineering programs as an ambassador at events.'
    },
    {
    ...
    },
    {
      ...
      date: 'Fall 2022 – Present',
      description: 'Participated in national and regional conferences and connected with Latinx engineers across the country.'
    },
    {
      title: 'Hackabull 2025',
      place: 'Participant',
      date: 'Spring 2025',
      description: 'Built Neo-Eden in a 36-hour hackathon alongside a team of 4, earning high engagement from judges.'
    },
    {
      title: 'ShellHacks 2024',
      place: 'Participant',
      date: 'Fall 2024',
      description: 'Co-developed WealthWise AI at Florida’s largest collegiate hackathon; ranked in Top 20 out of 300+ teams.'
    }
  ]
      ...
      <div className="min-h-screen bg-gray-300 text-gray-900 font-sans">
        ...
        <aside className="bg-black text-white w-full lg:w-1/3 p-6 pt-32 flex flex-col items-center text-center lg:fixed lg:h-full z-40">
          ...
          <div className="bg-gray-300 text-black rounded-2xl p-4 mt-6 flex justify-center gap-6">
            ...
            <a href="https://www.instagram.com/jordanrobertson.28/" target="_blank" rel="noopener noreferrer">
        ...
        <main className="w-full lg:ml-[33%] p-6 space-y-16 mt-6 pt-24">
          ...
          <section id="about">
            ...
            <div className="mt-6">
              ...
              <ul className="list-disc list-inside text-sm">
                ...
                <li>Refactored backend to support Prisma ORM and PostgreSQL with improved speed and integrity.</li>
              </ul>
            </div>
          ...
          <section id="contact" className="mt-16">
            ...
            <p>
              Email:{' '}
              <a
                  href="mailto:jordantyrobertson@gmail.com"
                  className="text-blue-600 underline"
              >
                jordantyrobertson@gmail.com
              </a>
            </p>
          </section>
        </main>
